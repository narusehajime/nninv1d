...
\title{Inverse modeling of turbidity currents using an artificial neural network approach: verification for field application}

% \Author[affil]{given_name}{surname}

\Author[1]{Hajime}{Naruse}
\Author[2]{Kento}{Nakao}

\affil[1]{Graduate School of Science, Kyoto University. Kitashirakawa Oiwakecho, Sakyo-ku, Kyoto, 606-8502 Japan}

\affil[2]{Baseload Power Japan. SHINTORA-DORI CORE 3F, 4-1-1, Shimbashi, Minato-ku, Tokyo, 105-0004 Japan}
...
\input{forward_model.tex}

\input{inverse_model.tex}
...
\codedataavailability{All codes and data used in this study is deposited in the respository Zenodo (https://doi.org/10.5281/zenodo.4135168)} %% use this section when having data sets and software code available
